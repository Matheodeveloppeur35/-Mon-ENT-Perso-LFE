...
const homeworkForm =
    document.getElementById("professional-homework-form");

const homeworkTitle =
    document.getElementById("professional-homework-title");

const homeworkDate =
    document.getElementById("professional-homework-date");

const homeworkDescription =
    document.getElementById("professional-homework-description");

const homeworkList =
    document.getElementById("professional-homework-list");
...
function afficherDevoirs() {
    ...
    if (devoirsProfessionnels.length === 0) {

        homeworkList.innerHTML = `
            <div class="empty-courses">
                📭 Aucun devoir d'enseignement professionnel
